...
#concaténation des X_train et W_train sur toutes les sessions sauf celle du test, concatener= mettre bout à bout les données de plusieurs sessions pour créer un seul grand tableau, permet d'entrainemer un modèle global sur plus de données 
